...
ki = LINETCR.LINE()
ki.login(token="EmjEWcboCLRqqmoEkyq0.URH3sLWIEUQ3mGJjlDYbqa.C9Wg71JUlk40tsG8Rn/VK2CqrmrRGpweNKgAupY0qwg=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EmCzJpqcUQJcanIV1P73.9qPM7NC2vWiRtQTZ/x4SyW.nVwBIYKhKxk2sHdlTk7O9UXdvnXAQE0Gk71DJYAvWWk=")
kk.loginResult()
...
kq = LINETCR.LINE()
kq.login(token="EmqfXUVHYVfMwFzXfmLe.WmA6l/6mupZgImKAkC1O3G.2HJXb0GNYhz1kDRDpW8whlwKZVhLbiqPMLizQTIGE8U=")
kq.loginResult()
...
��✒ C͍͇̪̲͎̯͎̫̩̽̅̈́̅̌́̍̐ŗ̛͔̳͔̦́̋͛̎e̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐ǻ͕͍̻̭̟̪͒́́̎̕͘̕͟t̢̠̻̗̠͙̦͒̉̈̎͂̐͒͑o̸̡̲̜̯̤͚̠̬͊̓̌̄̒͠r̵̺̲̗̩͙̐̇̾̐͐̏̃̓́̊ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞ 💋🕉unni͡° ͜ʖ ͡°oppa🕉✒•┅───── """
...
wait = {
    ...
    "lang":"JP",
    "comment":"AutoLike B͐͂̑̅y̅̉̑͞ 💋🕉unni͡° ͜ʖ ͡°oppa🕉✒•┅─────",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#=============================================
                ...
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%s<==U-k mora Server" % (elapsed_time))
