...
cl = LINETCR.LINE() 
#cl.login(qr=True)
cl.login(token="Eo8PBYfYXqMa46XIWsD9.3UrGMEjECFh9gbFk6EFekq.O4xAC8obAxI4PKEu2NgVJsPXwJbXKFPQ/rJLBffjPHo=")#1
cl.loginResult()

ki = LINETCR.LINE() 
#ki.login(qr=True)
ki.login(token="EopoZQ49sfSOAX6hBeH7.KN6gqRyZQ0iuRiU5jNIj1W.xbYexNOBmhqAs3waOGtE/MkcIFPa3EKEr3KESNyS6Xk=")#2
ki.loginResult()

kk = LINETCR.LINE() 
#kk.login(qr=True)
kk.login(token="EorfCRZClyvMN3MB9VOe.F6loN/ws9FaPqFRwqoggJG.FmFHkhig5zIMiHQwdNDd7Mq9K4LeuK8cXTEL4LDo38w=")#3
kk.loginResult()

kc = LINETCR.LINE() 
#kc.login(qr=True)
kc.login(token="EoXBecqW3ERWe7LBgJg3.9qPM7NC2vWiRtQTZ/x4SyW.jAIYdZ+leAeW1/MLtZcWvqQLNkGkqmGcYnZsZmQ/NDk=")#4
kc.loginResult()

ks = LINETCR.LINE() 
#ks.login(qr=True)
ks.login(token="EoLs7GzeWQvBTHe8PG6e.9lU+Lm8IEAdBW1wrKZGG7G.6qNWB1Ch2MBwISjX5ZFUvoIDyBGvR9vEI46dtAE2+eQ=")#5
ks.loginResult()

k1 = LINETCR.LINE() 
#k1.login(qr=True)
k1.login(token="Eod7dzA8UvmD1IxCZmPa.4873flXX7QJRw4jo2j7roG.fWe5i9/VBidflBRmvSvAy0XpfRJVwpvWKUOKIxLl+2o=")#6
k1.loginResult()

k2 = LINETCR.LINE() 
#k2.login(qr=True)
k2.login(token="EoB6OhiaRd2em6cV5Nu6.xkaL7HAdfdzB4bRIIC04jG.VummEw+rE6v+WwQzUjnfqUCMMMHQ7puipbooYzf/NE8=")#7
k2.loginResult()

k3 = LINETCR.LINE() 
#k3.login(qr=True)
k3.login(token="Eoiau00seLMIDdNJY150.X7ONBO4L4YtA49fO3i6lua.1dmRvQWkoDQ+/zWe1XyF92JaB8spDNF+zi8fLWcuC9k=")#8
k3.loginResult()

k4 = LINETCR.LINE() 
#k4.login(qr=True)
k4.login(token="EottLf29uAXUnlRbVJdb.tyEjT4SUhBFf7gJV34m+gW./n/Z5f1ID/4y/77xJGctC0D/igq8J6tI8kY4rLBz+0s=")#9
k4.loginResult()

k5 = LINETCR.LINE() 
#k5.login(qr=True)
k5.login(token="EojgEBlv4nUUyHe93di4.srjUosW4RgcA0sSjVMH6Ta.dLECyIIo8gVt7ZUViaadrwIcACEWRYSLthu8gBoWl6o=")#10
k5.loginResult()

satpam1 = LINETCR.LINE()  
satpam1.login(token="EogbsaEup2vVM5mxtdB8.MQvnSQmxLZyecm+cYLEska.IjlXmLZLDqz59W1LM/TIkILZ+nnGakSVGVCiECXO9Is=")#satpam1
#satpam1.login(qr=True)
satpam1.loginResult()

print "M.r_yena login success bos"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""

=࿅ོ࿆༼U.K-mora_yena bot protect༽࿅ོ࿆=

╠═════════════
║ ࿅ོ࿆༼menu for publik༽࿅ ོ࿆
║╔════════════
║╠[•]Help
║╠[•]Key
║╠[•]Mimin
...
admin=["udee46099e25e71f1fd1817cae9e7c429",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid1]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"""тerima Kasih Sudah Menambahkan Aku Jadi Teman anda salam kenal and salam santun""",
    "lang":"JP",
    "comment":"===========[[U.K_M O R A-Y E N A]]=======«««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
          ...
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              try:
                ...
                random.choice(KAC).sendText(op.param1, "Mau Ngundang Siapa ni😛")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
              except:
                random.choice(KAC).cancelGroupInvitation(op.param1, gMembMids)
                random.choice(KAC).sendText(op.param1, "Mau Ngundang Siapa ni😛")
          ...
          if wait["Protectjoin"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  cl.sendText(op.param1, "Kami lagi jaga Boss\noffin dulu kalo mau Ada yang Gabung\nJoinn on/off")
                except:
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                  cl.sendText(op.param1, "Kami lagi jaga Boss\noffin dulu kalo mau Ada yang Gabung\nJoinn on/off")
          ...
          if wait["Protectcancel"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                random.choice(KAC).sendText(op.param1, " hmmm.. main cancel aja...!!!\nsorry kami kick dulu 😛")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2]) 
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, "✔ ࿅ོ࿆༼U.K-mora_yena༽࿅ོ࿆\nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["cam.","Kr asup","Asup"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["out all","Ampih"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#----------------------------[Spam To Contact]----------------------------#WORK 
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Pamit all","Bot arampih"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                k4.sendText(msg.to,"★★★★★★★★★")
                k5.sendText(msg.to,"★★★★★★★★★★")
                random.choice(KAC).sendText(msg.to,"Semua Hadir Boss\siap jaga")
 ...
 #             msg.contentType = 13
  #            msg.contentMetadata = {'mid': 'udee46099e25e71f1fd1817cae9e7c429'}
   #           cl.sendText(msg.to,"======================")
    #          cl.sendMessage(msg)
     #         cl.sendText(msg.to,"======================")
      #        cl.sendText(msg.to,"Itu Creator Kami Yang yg p3 😜")  
