...
satpam1.login(token="EogbsaEup2vVM5mxtdB8.MQvnSQmxLZyecm+cYLEska.IjlXmLZLDqz59W1LM/TIkILZ+nnGakSVGVCiECXO9Is=")#satpam 
...
admin=["udee46099e25e71f1fd1817cae9e7c429",mid,Amid,Bmid,Cmid,Dmid,Emid,Smid1]
...
≫ Sorry Aku Ga Jawab PM Karna aq hanya sekedar bot saja≪""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By U.K_M O R A «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
profile.displayName = contact.displayName
profile.statusMessage = contact.statusMessage
profile.pictureStatus = contact.statusMessage
          ...
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              try:
                ...
                cl.sendText(op.param1, "kakak gak ada hak buat invit \nJadi Aku Cancel😛")
                cl.kickoutFromGroup(op.param1,[op.param2])
              except:
                random.choice(KAC).cancelGroupInvitation(op.param1, gMembMids)
                random.choice(KAC).sendText(op.param1, "kakak gak ada hak buat invit \nJadi Aku Cancel😛")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
...
#============================================================
            ...
            elif msg.text in ["Status","settings"]:
              if msg.from_ in admin:
                md = "⭐Status Proteksi⭐\n*============*\n"
                ...
                if wait["simiSimi"] == True: md+="[•]simiSimi [On]\n"
                else:md+="[•]simiSimi [Off]\n"
                if wait["detectMention"] == True: md+="[•]Auto respont [On]\n"
                else:md+="[•]Auto respont [Off]\n"
                if wait["kickMention"] == True: md+="[•]Kick tag [On]\n"
                else:md+="[•]Kick tag [Off]\n"
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in owner:
                ...
                time.sleep(0.01)
                k1.sendText(msg.to,"Hello " + str(ginfo.name))
                G = cl.getGroup(msg.to)
                ginfo = cl.getGroup(msg.to)
                G.preventJoinByTicket = True
                cl.updateGroup(G)
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        ks.leaveGroup(msg.to)
                        k1.leaveGroup(msg.to)
                        k1.sendText(msg.to,"Bye~Bye " + str(ginfo.name) + "\n\nJangan Lupa Bahagia...!!!")
                        #cl.leaveGroup(msg.to)
                    except:
                        pass
                      
            elif msg.text in ["Bye python"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
            elif msg.text in ["Ojo koyo python"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ki.leaveGroup(msg.to)
                        ...
                        pass
            elif msg.text in ["Ojo koyo sanca"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        kk.leaveGroup(msg.to)
                        ...
                        pass
            elif msg.text in ["Ojo koyo konda"]:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        kc.leaveGroup(msg.to)
...
#--------------------------------------------------------
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang dudul plus p3 😜")  
