...
helpMessage =""" ABY BOT Menu V.01  􀔃􀄆red check mark􏿿
...
wait = {
    ...
    "clock":True,
    "cName":"ABY MaN¥uÑ ",
    "cName2":"Ťēăm Çřęąţøř §ęłf 1 ",
    "cName3":"Ťēăm Çřęąţøř §ęłf 2 ",
    "cName4":"Ťēăm Çřęąţøř §ęłf 3",
    "blacklist":{},
    "wblacklist":True,
    "dblacklist":True,
    "ProtectQR":True,
...
def bot(op):
    try:
	   ...
	   if op.param3 in admin or Bots:
	      kk.inviteIntoGroup(op.param,[op.param3])
	   ...
	   if op.param3 in admin:
		...
		try:
			...
			ky.choice(KAC).inviteIntoGroup(op.param1,op.param3)
			cl.acceptGroupInvitation(op.param1)
	      print "Admin Joined"
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Masuk","All Join","All join","Ayo masuk"]:
              if msg.from_ in admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Pulang","Bot muleh","Bye all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#----------------Fungsi Creator Bot Start------------#
	    elif msg.text in ["Creator","Kreator","Author"]:
		msg.contentType = 13
		msg.contentMetadata = {'mid': 'udc9fd119ce88986a2d114f7efa652a43'}
		cl.sendMessage(msg)
		cl.sendText(msg.to, "☝ Itu Creator Dan Bos Saya ☝")
#---------------Fungsi Creator Bot Finis--------------#

    #-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Tag","Tag all","@tag"]:
		if msg.from_ in admin:
