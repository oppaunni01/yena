...
cl = LINETCR.LINE()
cl.login(token="EmAkiaztpmroMaQKPJr9.3UrGMEjECFh9gbFk6EFekq.LEPOUgeht4snaiZBZbOrdwgCjmt4Xjjn5glCaJZix2M=")
cl.loginResult()

ki = LINETRC.LINE()
ki.login(token="Em3LzdYUooKVqMdzqqze.F6loN/ws9FaPqFRwqoggJG.kp78pRy6hmFPLCcgUFF407IvK+MIWE4efFuqA53qO6I=")
ki.loginResult()
